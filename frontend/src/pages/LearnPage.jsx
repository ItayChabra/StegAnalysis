...
const STEPS = [
  { n: 1, title: 'Hide', body: 'Pick an image, type a message, optionally encrypt it, and embed it with one of four techniques.', to: '/embed', cta: 'Hide a message' },
...
export default function LearnPage() {
  return (
    <div className={ui.page}>
      ...
      <h2 className={styles.h2}>The four hiding techniques</h2>
